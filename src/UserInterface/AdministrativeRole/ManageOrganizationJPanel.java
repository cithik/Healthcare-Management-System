...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageOrganizationJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, OrganizationDirectory directory) {
        initComponents();
    ...
    private void populateCombo(){
        ...
        for (Type type : Organization.Type.values()){
            ...
            if(enterprise instanceof HospitalEnterprise){
                if (type.getValue().equals("Doctor Organization")||
                        (type.getValue().equals("Patient Organization"))){
                organizationJComboBox.addItem(type);
                }
            }else{
                if (type.getValue().equals("Drug Organization")||
                        (type.getValue().equals("Pharmacy Organization")))
                organizationJComboBox.addItem(type);
            }
            }
        }
    ...
    private void initComponents() {
        ...
        add(organizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 225, 172, -1));
