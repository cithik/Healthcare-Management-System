...
public class ManageUserAccount extends javax.swing.JPanel {
    ...
    public ManageUserAccount(JPanel container, Patient p, PatientDirectory patientDirectory, UserAccount account, Organization organization, Enterprise enterprise, Ecosystem business) {
        initComponents();
    ...
    public void popOrganizationComboBox() {
        ...
        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
            if(organization instanceof PatientAdminOrganization)
    ...
    public void populateEmployeeComboBox(Organization organization) {
        ...
        for (Person person : ((HospitalEnterprise)enterprise).getPatientDirectory().getPatientDirectory()) {
    ...
    private void populateRoleComboBox(Organization organization) {
        ...
        roleJComboBox.addItem(new PatientRole());
...
//        }
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        popData();
         JOptionPane.showMessageDialog(null, "Patient creation success");
        }
