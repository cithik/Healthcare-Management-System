...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        Person person = enterprise.getPersonDirectory().createPerson(name, "", network);
        ...
        if(account!=null)
        JOptionPane.showMessageDialog(null, "Enterprise Account created");
        else{
            JOptionPane.showMessageDialog(null, "User Name has to be unique");
        }
        }
